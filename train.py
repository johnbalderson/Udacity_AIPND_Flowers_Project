...
from image_utility import load_transform_data
from model import save_checkpoint, train_model, test_model
...
# Arguments:
#
# data-dir         - Path of training image folder (defaukt is 'flowers')
# save-dir         - Path to save model checkpoint (default is checkpoint.pth)
# arch             - select vgg16 or densenet121 model architecture (default is vgg16)
# category_names   - fle for mapping flower categories to category names (default is cat_to_name.json)
# learning_rate    - set learning rate (defailt is 0.003)
# hidden_units     - set number of hidden units (default is 500)
# dropout          - set dropout rate (default is 0.03)
# epochs           - set number of epochs (default is 3)
# device           - set device type mode for cuda or cpu (default is cuda)
